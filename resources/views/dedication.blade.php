...
<title>Musik | Web Application</title>
 ...
 <script src="http://localhost/Fuck/resources/assets/js/ie/excanvas.js"></script> <![endif]-->
 </head>
 <body class=""> 
 <section class="vbox"> 
 ...
 <div class="navbar-header aside bg-info dk"> 
	...
	<i class="icon-settings"></i> </a> </div> <ul class="nav navbar-nav hidden-xs"> <li> 
	...
	<input type="text" class="form-control input-sm no-border rounded" placeholder="Search songs, albums..."> </div> </div> 
	</form>

	<div class="navbar-right "> <ul class="nav navbar-nav m-n hidden-xs nav-user user"> 
	<li class="hidden-xs"> 
	...
	<div class="list-group list-group-alt"> 
		<a href="#" class="media list-group-item"> 
			<span class="pull-left thumb-sm"> 
				<img src="http://localhost/Fuck/resources/assets/images/a0.png" alt="..." class="img-circle"> 
			</span> 
	...
	<li class="dropdown"> 
		...
		<img src="http://localhost/Fuck/resources/assets/images/a0.png" alt="..."> </span> John.Smith <b class="caret"></b> 
		</a> 
 ...
 <!-- .aside --> 
	...
	<li> <a href="index-2.html"> <i class="icon-disc icon text-success"></i> 
	...
	<ul class="nav" data-ride="collapse"> 
		...
		<li > <a href="layout-color.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Color option</span> </a> 
		</li> 
		<li > <a href="layout-boxed.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Boxed layout</span> </a> 
		</li> 
		<li > <a href="layout-fluid.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Fluid layout</span> </a> 
		</li> 
		</ul> 
		</li> 
		...
		<ul class="nav dk text-sm"> 
		<li > <a href="buttons.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Buttons</span> </a> 
		</li> 
		
		<li > <a href="icons.html" class="auto"> 
		<b class="badge bg-info pull-right">369</b> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Icons</span> </a> </li> 
		
		<li > <a href="grid.html" class="auto"> <i class="fa fa-angle-right text-xs"></i> 
		<span>Grid</span> </a> </li> 
		
		<li > <a href="widgets.html" class="auto"> 
		<b class="badge bg-dark pull-right">8</b> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Widgets</span> </a> 
		</li> 
		
		<li > <a href="components.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Components</span> </a> 
		</li> 
		
		<li > <a href="list.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>List group</span> </a> 
		</li> 
		
		<li > <a href="#table" class="auto"> <span class="pull-right text-muted"> 
		<i class="fa fa-angle-left text"></i> <i class="fa fa-angle-down text-active"></i> 
		...
		<li > <a href="chart.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Chart</span> </a> 
		</li>

		<li > <a href="portlet.html" class="auto">
		<i class="fa fa-angle-right text-xs"></i>
		<span>Portlet</span> </a> 
		</li> 
		
		<li > <a href="timeline.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		...
		<i class="fa fa-angle-left text"></i> 
		<i class="fa fa-angle-down text-active"></i> 
		</span> <i class="icon-grid icon"> </i> 
		<span>Pages</span> </a> 
		
		
		<ul class="nav dk text-sm"> 
		<li > <a href="profile.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Profile</span> </a> 
		...
		<li > <a href="blog.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> <span>Blog</span> </a> 
		</li> 
		
		<li > <a href="invoice.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Invoice</span> </a> 
		</li>

		<li > <a href="gmap.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Google Map</span> </a> 
		</li>

		<li > <a href="jvectormap.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Vector Map</span> </a> 
		</li> 
		
		<li > <a href="signin.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Signin</span> </a> 
		</li> 
		
		
		<li > <a href="signup.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>Signup</span> </a> 
		</li> 
		
		<li > <a href="404.html" class="auto"> 
		<i class="fa fa-angle-right text-xs"></i> 
		<span>404</span> </a> 
		</li> 
		</ul> 
		...
		<i class="icon-plus i-lg"></i></a></span> Playlist 
		</li> 
		...
		<li> <a href="#"> <i class="icon-playlist icon text-success-lter"></i> 
		<b class="badge bg-success dker pull-right">9</b> <span>Jazz</span> </a> 
		</li> 
		</ul>
		</nav> 
		...
		<i class="on b-black"></i> </span> 
		<span class="hidden-nav-xs clear"> 
		<span class="block m-l"> 
		<strong class="font-bold text-lt">John.Smith</strong> 
		<b class="caret"></b> </span> 
		<span class="text-muted text-xs block m-l">Art Director</span> </span> </a> 
		...
		<div> <a class="jp-full-screen" title="full screen">
		<i class="fa fa-expand"></i></a> 
		<a class="jp-restore-screen" title="restore screen">
		<i class="fa fa-compress text-lt"></i></a> 
		</div> 
		</div> 
		</div> 
		</div> 
		...
		<div class="wrapper-lg"> 
			...
			<div class="post-sum"> 
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id neque quam. Aliquam sollicitudin venenatis ipsum ac feugiat. Vestibulum ullamcorper sodales 
				nisi nec condimentum. Mauris convallis mauris at pellentesque volutpat. <br><br> Phasellus 
				at ultricies neque, quis malesuada augue. Donec eleifend condimentum nisl eu consectetur. 
				Integer eleifend, nisl venenatis consequat iaculis, lectus arcu malesuada sem, dapibus 
				porta quam lacus eu neque.
				</p> 
			</div> 
			...
			<div class="text-muted">
				...
				<a href="#" class="m-l-sm">
				<i class="fa fa-comment-o icon-muted"></i> 3 comments</a> 
			</div> 
		</div> 
		</div> 
		...
		<section class="comment-list block"> 
			...
			<article id="comment-id-1" class="comment-item">
				...
				<img src="http://localhost/Fuck/resources/assets/images/a0.png" class="img-circle"> </a> 
			...
			<article id="comment-id-2" class="comment-item comment-reply"> 
				<a class="pull-left thumb-sm"> <img src="images/a1.png" class="img-circle"> </a> 
				<section class="comment-body m-b"> 
			...
			<article id="comment-id-2" class="comment-item"> 
				<a class="pull-left thumb-sm"> 
				<img src="http://localhost/Fuck/resources/assets/images/a2.png" class="img-circle"> </a> 
				<section class="comment-body m-b"> 
					<header> <a href="#"><strong>John smith</strong></a> 
					<label class="label bg-dark m-l-xs">Admin</label> 
					<span class="text-muted text-xs block m-t-xs"> 26 minutes ago </span> 
					</header> 
					<blockquote class="m-t"> <p>Lorem ipsum dolor sit amet, 
		...
		<img src="http://localhost/Fuck/resources/assets/images/m40.jpg"> </a> 
		...
		<article class="media"> 
		<a href="#" class="pull-left thumb-lg m-t-xs"> 
		<img src="http://localhost/Fuck/resources/assets/images/m41.jpg"> </a> 
		<div class="media-body"> 
		...
		<article class="media"> <a href="#" class="pull-left thumb-lg m-t-xs"> 
		<img src="http://localhost/Fuck/resources/assets/images/m42.jpg"> </a> 
		<div class="media-body">
		...
		<article class="media"> 
		<a href="#" class="pull-left thumb-lg m-t-xs"> 
		<img src="http://localhost/Fuck/resources/assets/images/m43.jpg"> </a> 
		<div class="media-body"> 
		...
		<article class="media"> 
		<a href="#" class="pull-left thumb-lg m-t-xs"> 
		<img src="http://localhost/Fuck/resources/assets/images/m44.jpg"> </a> 
		<div class="media-body"> 
		...
		<article class="media"> 
			<a href="#" class="pull-left thumb-lg m-t-xs"> 
			<img src="http://localhost/Fuck/resources/assets/images/m45.jpg"> </a> 
			<div class="media-body"> 
