...
(function(b, f) {
    ...
    jPlayerPlaylist.prototype = {
       ...
       /***************** Function Show Next Song Information By Ashad ***********************/
       nextInfo: function(a) {
          var ashad = this.current + 1 < this.playlist.length ? this.current + 1 : 0;
           if(ashad>=1)
               $('#next_song_title').html("Next:"+this.playlist[ashad].title);
         },
        /***************************************************************/
        play: function(a) {
         ...
         // Add By ashad
            ...
            if(ashad>=1)
                $('#next_song_title').html("Next:"+this.playlist[ashad].title);
         //   nextTitle: ".next_song_title"
          //  $('#next_song_title').htm('Yes next');
        //   alert(this.next_message.text());
          //  alert(this.playlist[ashad].title);
           // this.nextData(ashad);
           // End
        },
        pause: function() {
