...
(function(b, f) {
    ...
    b.jPlayer.prototype = {
        ...
        _updateInterface: function() {
            ...
            this.css.jq.duration.length && ("string" === typeof this.status.media.duration ? a = this.status.media.duration : ("number" === typeof this.status.media.duration && (a = this.status.media.duration, c = a - this.status.currentTime), a = this.options.remainingDuration ? (0 < c ? "-" : "") + this._convertTime(c) : this._convertTime(a)), a !== this.css.jq.duration.text())
           // alert(a);
            if(a=='0')
            {
                a="00:00";
            ...
            this.css.jq.currentTime.text(this._convertTime(this.status.currentTime)+'/'+a);
        },
        ...
        play: function(a) {
           // alert(this.status.srcSet);
            // alert(a );
            a = "number" === typeof a ? a : NaN;
            this.status.srcSet ? (this.focus(), this.html.active ? this._html_play(a) : this.flash.active && this.c(a)) : this._urlNotSetError("play")
        },
        videoPlay: function() {
            this.play()
        },
